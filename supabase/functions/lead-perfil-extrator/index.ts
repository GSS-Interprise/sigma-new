...
Retorne JSON válido com esse schema exato:
{
  ...
  "forma_pagamento_preferida": "por_plantao"|"por_producao"|"por_hora"|"fixo_mensal"|"misto" | null,
  "objecoes": ["valor_baixo"|"distancia"|"ja_tem_vinculo"|"carga_horaria_alta"|"prefere_outra_regiao"|"burocracia_documentos"|"sem_interesse_no_momento"|"desconfianca"|"outro"],
  "temas": ["tags livres curtas em snake_case sobre o que o médico mencionou que não cabe nos campos acima (ex: interesse_telemedicina, so_fins_de_semana, exige_alojamento, quer_carteira_assinada). [] se nada relevante."],
  ...
  "mudancas_vs_perfil_atual": "texto curto sobre o que mudou"
    ...
    const payload = {
      ...
      forma_pagamento_preferida: asString(parsed.forma_pagamento_preferida),
      objecoes: asStringArray(parsed.objecoes),
      temas: asStringArray(parsed.temas),

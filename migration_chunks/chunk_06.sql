...
DO $$ BEGIN ALTER TABLE public.captacao_permissoes_usuario 
ADD COLUMN IF NOT EXISTS cor TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN IF NOT EXISTS aprovado_corpo_medico_por uuid; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN reaction TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE contratos ALTER COLUMN codigo_interno SET DEFAULT nextval('contratos_codigo_interno_seq'); EXCEPTION WHEN undefined_column THEN NULL; WHEN undefined_table THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.contratos ADD COLUMN IF NOT EXISTS licitacao_origem_id UUID REFERENCES public.licitacoes(id); EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN IF NOT EXISTS servicos_contrato jsonb DEFAULT '[]'::jsonb; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.licitacoes 
ADD COLUMN IF NOT EXISTS check_conversao_1 boolean DEFAULT false; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE public.licitacoes 
ADD COLUMN IF NOT EXISTS check_conversao_2 boolean DEFAULT false; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE public.licitacoes 
ADD COLUMN IF NOT EXISTS check_conversao_3 boolean DEFAULT false; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE TYPE origem_tipo_board AS ENUM ('manual', 'licitacao_arrematada'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Criar enum para status do kanban de captação
DO $$ BEGIN CREATE TYPE status_captacao_board AS ENUM ('prospectar', 'analisando', 'em_andamento', 'completo', 'descarte'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.contrato_rascunho 
ADD COLUMN IF NOT EXISTS status_kanban text NOT NULL DEFAULT 'prospectar'; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

-- Adicionar coluna servicos_json para array de serviços
DO $$ BEGIN ALTER TABLE public.contrato_rascunho 
ADD COLUMN IF NOT EXISTS servicos_json jsonb DEFAULT '[]'::jsonb; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN IF NOT EXISTS servicos_licitacao jsonb DEFAULT '[]'::jsonb; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN IF NOT EXISTS unidades_vinculadas uuid[] DEFAULT '{}'; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
ADD COLUMN IF NOT EXISTS status_contrato TEXT DEFAULT 'Ativo'; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.leads 
ADD COLUMN IF NOT EXISTS migrado_de_medico_id uuid UNIQUE; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

-- 2. Coluna para timestamp da migração
DO $$ BEGIN ALTER TABLE public.leads 
ADD COLUMN IF NOT EXISTS migrado_de_medico_em timestamp with time zone; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE licitacoes_atividades ALTER COLUMN user_id DROP NOT NULL; EXCEPTION WHEN undefined_column THEN NULL; WHEN undefined_table THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.contratos ADD CONSTRAINT check_cliente_ou_medico 
  CHECK (
...
DO $$ BEGIN ALTER TABLE public.contratos ADD CONSTRAINT contratos_status_contrato_check 
  CHECK (status_contrato IN ('Ativo', 'Inativo', 'Encerrado', 'Suspenso', 'Em Renovação', 'Pre-Contrato')); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
ADD COLUMN reply_to_id uuid REFERENCES public.comunicacao_mensagens(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.licitacoes_atividades
  ...
  ON DELETE SET NULL; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE public.proposta ADD COLUMN IF NOT EXISTS contrato_id uuid REFERENCES public.contratos(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.proposta ADD COLUMN IF NOT EXISTS unidade_id uuid REFERENCES public.unidades(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

-- 2. Make servico_id nullable (for backwards compatibility)
DO $$ BEGIN ALTER TABLE public.proposta ALTER COLUMN servico_id DROP NOT NULL; EXCEPTION WHEN undefined_column THEN NULL; WHEN undefined_table THEN NULL; END $$;

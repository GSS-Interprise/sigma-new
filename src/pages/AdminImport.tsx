...
const TABLES = [
  ...
  "contrato_aditivos_tempo", "contrato_aditivos_tempo_dr_escala", "contrato_aditivos_tempo_dr_oportunidade",
  "contrato_anexos", "contrato_anexos_dr_escala", "contrato_anexos_dr_oportunidade",
  "contrato_capitacao", "contrato_itens", "contrato_itens_dr_escala", "contrato_itens_dr_oportunidade",
  "contrato_rascunho", "contrato_rascunho_anexos",
  "contrato_renovacoes", "contrato_renovacoes_dr_escala", "contrato_renovacoes_dr_oportunidade",
  "contratos", "contratos_demanda", "contratos_dr_escala", "contratos_dr_oportunidade", "contratos_medico",
  "conversas", "demandas",
  ...
  "escalas_ambulatoriais_fontes", "escalas_ambulatoriais_logs", "escalas_ambulatoriais_templates",
  "escalas_api_tokens", "escalas_inconsistencias",
  "escalas_integracao_logs", "escalas_integradas", "escalas_locais", "escalas_setores",
  "especialidades", "eventos",
  "financeiro_config_valores", "financeiro_pagamento_itens", "financeiro_pagamentos",
  "historico_acessos", "import_leads_failed_queue", "instance_proxy_settings",
  "kanban_status_config", "lead_anexos", "lead_anotacoes", "lead_historico", "lead_import_jobs",
  "leads", "leads_bloqueio_temporario", "leads_etiquetas_config",
  "licitacao_descartes", "licitacao_item_concorrentes", "licitacao_itens",
  "licitacao_motivos_descarte", "licitacao_resultados",
  "licitacoes", "licitacoes_anexos", "licitacoes_atividades",
  "licitacoes_colunas", "licitacoes_edit_locks", "licitacoes_etiquetas_config", "licitacoes_notificacoes_prazo",
  "marketing_contas", "marketing_conteudos", "marketing_endomarketing",
  "marketing_eventos", "marketing_ideias", "marketing_leads",
  "marketing_planejamentos", "marketing_prioridades", "marketing_trafego_pago",
  "materiais_biblioteca", "medico_ausencias", "medico_documentos", "medico_documentos_log",
  "medico_indisponibilidades", "medico_kanban_card_anexos", "medico_kanban_cards",
  "medico_prontuario", "medico_remuneracao", "medico_vinculo_unidade", "medicos",
  "mensagens", "menu_permissions", "modulos_manutencao",
  ...
  "recebimentos_cliente", ""radiologia_producao_exames", "recebimentos_cliente", "banco_interesse_leads",",

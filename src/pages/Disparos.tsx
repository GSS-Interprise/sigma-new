...
import { Send, Mail, LayoutDashboard, Users, Ban, MessageCircle, Settings, FileText, ShieldCheck, MapPin, Eye, Wrench, GraduationCap, Megaphone, ListTodo } from "lucide-react";
...
export default function Disparos() {
  ...
  const allModules = [
    ...
    { name: "Tarefas e Solicitações", href: "/disparos/tarefas", icon: ListTodo, description: "Leads abertos, follow-ups e gatilhos por canal", permission: "leads" as CaptacaoPermission, adminOnly: false },
  ];

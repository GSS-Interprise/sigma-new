...
export default function Disparos() {
  ...
  const allModules = [
    ...
    { name: "Conversas WhatsApp", href: "/disparos/sigzap", icon: MessageCircle, description: "Atendimento das mensagens recebidas", permission: "seigzaps_config" as CaptacaoPermission, adminOnly: false },
    { name: "Chips & Instâncias", href: "/disparos/config", icon: Settings, description: "Configure chips e instâncias do WhatsApp", permission: "seigzaps_config" as CaptacaoPermission, adminOnly: false },

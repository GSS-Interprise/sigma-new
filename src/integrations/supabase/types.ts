  ...
  public: {
    Tables: {
      ...
      campanhas: {
        Row: {
          ...
          id: string
          leads_excluidos_ids: string[] | null
          ...
          tarefa_cadencia_passos: Json | null
          tarefa_cadencia_template_id: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "campanhas_tarefa_cadencia_template_id_fkey"
            columns: ["tarefa_cadencia_template_id"]
            isOneToOne: false
            referencedRelation: "tarefa_cadencia_templates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      cfm_import_audit: {
        Row: {
          acao: string
          crm_anterior: string | null
          crm_setado: string | null
          executado_em: string
          id: number
          lead_id: string
          lote: string
      ...
      cfm_medicos_staging: {
        Row: {
          ...
          nu_crm: string
          nu_crm_natural: string | null
          prim_inscricao_uf: string | null
          sg_uf: string
      ...
      sigzap_pinned_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "sigzap_pinned_conversations_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "sigzap_conversations"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      vw_campanhas_dashboard: {
        Row: {
          aquecido: number | null
          campanha_id: string | null
          chip_aquecedor_ativo: boolean | null
          chip_capacidade_restante: number | null
          chip_conexao: string | null
          chip_envios_24h: number | null
          chip_fase: string | null
          chip_health: number | null
          chip_limite_dia: number | null
          chip_pausado_ate: string | null
          chip_pause_motivo: string | null
          chip_pode_disparar: boolean | null
          chip_principal: string | null
          chip_principal_id: string | null
      ...
      vw_lead_perfil_360: {
        Row: {
          ...
          vezes_convertido: number | null
          vezes_perdido: number | null
          vezes_quente: number | null
        }
        Insert: {
          campanhas_ativas?: never
          cidade?: string | null
          classificacao?: string | null
          convertido_por?: string | null
          cooldown_ate?: string | null
          ...
          phone_e164?: string | null
          tags?: string[] | null
          total_campanhas?: never
          uf?: string | null
          ultima_msg_sigzap?: never
          vezes_convertido?: never
          vezes_perdido?: never
          vezes_quente?: never
        }
        Update: {
      ...
      vw_leads_funil_stats: {
        Row: {
          blacklist: number | null
          convertidos: number | null
          em_campanha: number | null
          novos_7d: number | null
          opt_out: number | null
          proibidos: number | null
          quentes: number | null
    ...
    Functions: {
      ...
      duplicar_campanha_para_manual: {
        Args: { p_campanha_origem: string; p_qtd_leads: number }
        Returns: string
      }

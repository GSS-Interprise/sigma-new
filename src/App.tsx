...
import DisparosCampanhas from "./pages/DisparosCampanhas";
...
const App = () => (
  <ErrorBoundary label="App (global)">
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <AuthProvider>
            ...
            <Route path="/licitacoes/robo" element={<ProtectedRoute><PermissionRoute modulo="licitacoes"><Licitacoes board="robo" /></PermissionRoute></ProtectedRoute>} />
            ...
            <Route path="/disparos/campanhas" element={<ProtectedRoute><PermissionRoute modulo="disparos"><DisparosCampanhas /></PermissionRoute></ProtectedRoute>} />
